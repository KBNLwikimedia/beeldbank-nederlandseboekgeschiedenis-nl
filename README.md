...
4. **Upload to Commons** (`scripts/uploader.py`) - Upload images with `{{Artwork}}` template wikitext generated by `scripts/commons_template.py`. Includes throttling and exponential backoff.
5. **Add structured data** (`scripts/structured_data.py`) - Add Wikibase structured data statements to each file
